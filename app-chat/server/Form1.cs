    ...
    public partial class Form1 : Form
    {
        ...
        void Receive(object obj)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    string connString = "server=WINDOWS-11\\SQLEXPRESS; database = SocketChat; Integrated Security = true; ";
                    ...
                    switch (ms.action)
                    {
                        case "login":
                            ...
                            cmd.CommandText = string.Format("select * from Users where username = '{0} and password = '{1}'", ms.user.UserName, ms.user.Password);
        ...
        {
            Connect();
            string text = "server đang chạy ở địa chỉ 127.0.0.1 và cổng 9999";
            string text1 = "Server đang chạy... ";
